...
{
    public class csBulkLevel1UpdateEventArgs : EventArgs
    {
        #region Fields 

        private DateTime timeStamp;
        private List<byte[]> updates;//make sure these are only level1 related messages...
        ...
        public csBulkLevel1UpdateEventArgs(DateTime timeStamp, List<byte[]> updates, List<ushort> updateTypes)
        {
